...
using static onlinestore.Models.MemberModel;
...
namespace onlinestore.Controllers
{
    public class MemberController : Controller
    {
		...
		public ActionResult GetUserProfile()
		{
			...
			using (SqlConnection conn = new SqlConnection(connStr))
			{
				...
				if (dt.Rows.Count > 0)
				{
					...
					outModel.UserPwd = dt.Rows[0]["UserPwd"].ToString();
        ...
        public ActionResult Book0101()
        {
            return View();
        }
		public ActionResult Book0102()
		{
			return View();
		}
		public ActionResult Book0103()
		{
			return View();
		}
	}
